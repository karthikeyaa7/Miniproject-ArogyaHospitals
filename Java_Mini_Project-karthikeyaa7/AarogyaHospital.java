...
class Arogya {
	...
	public void add() {
		...
		Patient p1 = new Patient();
            ...
            //s.nextLine();
            if(z==true){
                System.out.print("Please Re-enterId: ");
            }
        ...
        while(y==true){
            ...
            if(y==true){
                System.out.print("Please Re-enter Age: ");
            }
        ...
        while(x==true){
            ...
            if(x==true){
                System.out.print("Please Re-enter Aadharcard Number: ");
            }
        }
        ...
        while(v==true){
            ...
            if(v==true){
                System.out.print("Please Re-enter Guardian phone number: ");
            }
        }
        ...
        while(t){
            ...
            if(t==true){
                System.out.print("Please Re-enter patient status: ");
            }
        }
